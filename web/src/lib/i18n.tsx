...
const zhCN = {
  ...
  monitor: {
    ...
    evolveStatus: { running: '运行中', waiting_approval: '待审批', success: '成功', stopped: '已停止', failed: '失败' },
    refresh: '刷新',
    liveConnected: '实时连接',
    offline: '离线',
    teamRuns: '团队运行',
...
const enUS: I18nDict = {
  monitor: {
    ...
    evolveStatus: { running: 'Running', waiting_approval: 'Awaiting', success: 'Success', stopped: 'Stopped', failed: 'Failed' },
    refresh: 'Refresh',
    liveConnected: 'Live',
    offline: 'Offline',
    teamRuns: 'Team runs',
